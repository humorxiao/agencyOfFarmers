...
!function () {
  ...
  var De = "sizzle" + -new Date, Oe = window.document, Pe = 0, Le = 0, Ie = pt(), Me = pt(), Fe = pt(),
    ze = function (e, t) {
      return e === t && (ce = !0), 0
    }, Ue = typeof undefined, qe = {}.hasOwnProperty, Ve = [], He = Ve.pop, je = Ve.push, $e = Ve.push, We = Ve.slice,
  ...
  var At = Array.isArray, Rt = function (e, t, n) {
    ...
    Jt = {"for": "htmlFor", "class": "className", readonly: "readOnly"}, Qt = {"float": "cssFloat"}, Zt = {}, en = {},
    tn = function (e, t) {
  ...
  var dn, mn = function (e) {
    ...
    }], Mn = [{name: "Windows", search: Ln("win"), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/]}, {
      name: "iOS",
      search: function (e) {
  ...
  function hi(a, u) {
    ...
    var r = {}, i = window, o = {}, t = 0, e = function (m, e) {
      ...
      m = u.ownEvents ? new Be(u.proxy) : Be.Event, n = f.getBlockElements(), p = tn.overrideDefaults(function () {
        ...
        loadCSS: function (e) {
          ...
          q === hi.DOM || a !== document ? (e || (e = ""), n = a.getElementsByTagName("head")[0], si(e.split(","), function (e) {
            var t;
            e = It._addCacheSuffix(e), o[e] || (o[e] = !0, t = B("link", {rel: "stylesheet", href: e}), n.appendChild(t))
          })) : hi.DOM.loadCSS(e)
        },
  ...
  var ki, Ti = "\ufeff", Ai = function (e) {
    ...
    Xi = Oo.matchNodeNames("img input textarea hr iframe video audio object"), Yi = Oo.matchNodeNames("table"), Gi = Li,
    Ji = function (e) {
  ...
  var Oa, Pa, La = Da, Ia = Oo.isElement, Ma = Oo.isText, Fa = function (e) {
    ...
    fromPosition: Ga, nextPosition: V.curry(Ga, !0), prevPosition: V.curry(Ga, !1), navigate: function (t, n, r) {
  ...
  var Qc = function (a) {
    ...
    var n, r, o = "string" != typeof(n = t) ? (r = It.extend({paste: n.paste, data: {paste: n.paste}}, n), {
      content: n.content,
      details: r
    }) : {content: n, details: {}};
    ...
    e({
      "mceResetDesignMode,mceBeginUndoLevel": function () {
        ...
        if ("paste" !== e || n.queryCommandEnabled(e) || (t = !0), t || !n.queryCommandSupported(e)) {
          ...
          ve.mac && (r = r.replace(/Ctrl\+/g, "\u2318+")), s.notificationManager.open({text: r, type: "error"})
        }
      }, unlink: function () {
        if (i.isCollapsed()) {
  ...
  function hh(F, z) {
    ...
    var U = F.comment ? F.comment : e, q = F.cdata ? F.cdata : e, V = F.text ? F.text : e, H = F.start ? F.start : e,
      j = F.end ? F.end : e, $ = F.pi ? F.pi : e, W = F.doctype ? F.doctype : e;
    return {
      parse: function (e) {
        var t, n, r, d, o, i, a, m, u, s, p, c, g, l, f, h, v, y, b, C, x, w, N, E, S, k, T, A, R, _ = 0, B = [], D = 0,
          O = Ko.decode, P = It.makeMap("src,href,data,background,formaction,poster,xlink:href"),
  ...
  var yy = function (a) {
    ...
    Ry = function (e, t, n) {
      ...
      g.remove_trailing_brs && e.addNodeFilter("br", function (e, t, n) {
        var r, o, i, a, u, s, c, l, f = e.length, d = It.extend({}, h.getBlockElements()), m = h.getNonEmptyElements(),
    ...
    var D = function (e) {
      ...
      schema: T, addAttributeFilter: function (e, n) {
        ...
        var p = T.getNonEmptyElements(), g = T.children, h = k.validate,
          v = "forced_root_block" in a ? a.forced_root_block : k.forced_root_block, y = T.getWhiteSpaceElements(),
          b = /^[ \t\r\n]+/, C = /[ \t\r\n]+$/, x = /[ \t\r\n]+/g, w = /^[ \t\r\n]+$/;
  ...
  var Xy = Ky, Yy = Oo.isContentEditableFalse, Gy = Oo.isContentEditableTrue, Jy = function (r, a) {
    ...
    }, ab = kr.immutable("element", "width", "rows"), ub = kr.immutable("element", "cells"), sb = kr.immutable("x", "y"),
    cb = function (e, t) {
      ...
      i.on("keydown", function (e) {
        ...
        }, {keyCode: sh.RIGHT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: sd.moveNextWord(t, n)}, {
          keyCode: sh.LEFT,
          ctrlKey: !o.isOSX(),
          altKey: o.isOSX(),
  ...
  function UC(u) {
    var s, n, r, o = It.each, c = sh.BACKSPACE, l = sh.DELETE, f = u.dom, d = u.selection, e = u.settings, t = u.parser,
      i = ve.gecko, a = ve.ie, m = ve.webkit, p = "data:text/mce-internal,", g = a ? "Text" : "URL",
      h = function (e, t) {
        try {
  ...
  var Tw, Aw = window.localStorage, Rw = nw, _w = {
    ...
    html: {Styles: ai, Entities: Ko, Node: _y, Schema: oi, SaxParser: vh, DomParser: qy, Writer: Gc, Serializer: Jc},
    ui: {Factory: pw},
    Env: ve,
    AddOnManager: Si,
    Formatter: vy,
