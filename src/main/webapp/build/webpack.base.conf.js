...
const createLintingRule = () => ({
  ...
  enforce: 'pre',
  include: [resolve('WEB-INF'), resolve('test')],
  options: {
...
module.exports = {
  ...
  entry: {
    app: resolve('WEB-INF/main.js'),
    login: resolve('WEB-INF/login.js'),
    register:resolve('WEB-INF/register.js'),
    contactus:resolve('WEB-INF/contactus.js'),
  ...
  module: {
    rules: [
      ...
      },
      {
        test: /\.js$/,
        loader: 'babel-loader',
        include: [resolve('WEB-INF'), resolve('test'), resolve('node_modules/webpack-dev-server/client')]
      },
      {
