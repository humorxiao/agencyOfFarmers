      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li id="user-3" class="dropdown" v-if="login_status == 1" :style="{display: block}">
              <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" @click = "personalButton()"><span id="fl-user-name"></span>个人中心<span class="caret"></span></a>
