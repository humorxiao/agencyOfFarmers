...
public class WXPaySender {
     ...
     */
    public JSONObject doUnifiedOrder(JSONObject json) {
        HashMap<String, String> data = new HashMap<String, String>();
        JSONObject temp = new JSONObject();
        data.put("body", json.get("product").toString());
        data.put("out_trade_no", json.get("Order_ID").toString());
        data.put("total_fee", json.get("Order_PayPrice").toString());
        data.put("spbill_create_ip", json.get("ip").toString());
        ...
        temp.put("code_url", result.get("code_url"));
        return temp;
    }
     ...
     */
    public JSONObject doOrderQuery(String trade_no) {
        HashMap<String, String> data = new HashMap<String, String>();
        JSONObject temp = new JSONObject();
        ...
        temp.put("trade_state", result.get("trade_state"));
        return temp;
    }
